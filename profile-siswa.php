...
<body>
    <?php 
         ...
         include 'conn.php';
         session_start();
         $qry=mysqli_query($conn,"select * from siswa join kelas on siswa.id_kelas=kelas.id_kelas where username = '".$_SESSION['username']."'");
                            ...
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    ...
                                    <div class="media-body">
                                        <h3 class="mb-0"><?=$dt_admin['nama']?></h3>
                                        <p class="text-muted mb-0"><?=$dt_admin['nama_kelas']?></p>
                                    </div>
                                </div>
                            ...
                            <div class="basic-form">
                                    <form>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" value="<?=$dt_admin['nisn']?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">NIS</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?=$dt_admin['nis']?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?=$dt_admin['nama']?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Kelas</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" value="<?=$dt_admin['nama_kelas']?>" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">

            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <h4 class="card-title">Tuition Bill Payment</h4>
                        <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Bulan</th>
                            ...
                            <?php 
                                ...
                                $ket = 'LUNAS';
                                $sql= mysqli_query($conn ,"select * from pembayaran join spp on pembayaran.id_spp=spp.id_spp WHERE nisn = '$data[nisn]'  and jatuh_tempo < '$date' and tgl_bayar IS NULL ORDER BY jatuh_tempo ASC ");
                                ...
                                <tr>
                                    <td colspan="6" align="left">TOTAL TUNGGAKAN</td>

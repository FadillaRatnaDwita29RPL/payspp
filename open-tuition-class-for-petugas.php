                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="browse-student-for-petugas.php?nisn=<?php echo $data['nisn']?>"><button class="btn btn-primary px-2">Browse</button></a>
                                        <a href="history-student-for-petugas.php?nisn=<?php echo $data['nisn']?>"><button class="btn btn-danger px-2">History</button></a>
                                    </td>
                                </tr>
                                <?php } ?>

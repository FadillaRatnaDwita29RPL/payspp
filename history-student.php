                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <?php 
                                $sql= mysqli_query($conn ,"select * from petugas join pembayaran on petugas.id_petugas=pembayaran.id_petugas join spp on pembayaran.id_spp=spp.id_spp WHERE nisn = '$data[nisn]' and keterangan = 'LUNAS' and tgl_bayar IS NOT NULL ORDER BY jatuh_tempo ASC ");

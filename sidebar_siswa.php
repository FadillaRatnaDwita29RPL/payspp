    ...
    <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="index_siswa.php" aria-expanded="false">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="bill-tuition.php">Bill</a></li>
                            <li><a href="history-tuition-siswa.php">History</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="logout-siswa.php" onclick="return confirm('Are you sure to log out?')">

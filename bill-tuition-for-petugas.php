                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <?php 
                                $date = date('Y-m-d');
                                $ket = 'LUNAS';
                                $sql= mysqli_query($conn ,"select * from pembayaran join spp on pembayaran.id_spp=spp.id_spp WHERE nisn = '$nisn'  and jatuh_tempo < '$date' and tgl_bayar IS NULL ORDER BY jatuh_tempo ASC ");

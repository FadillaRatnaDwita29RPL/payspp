            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="input-group icons">
                            <form action="search-tuition.php" method="get">
                                <table class="table">
                                <td>
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?=$data['jurusan']?></td>
                                    <td><?=$data['angkatan']?></td>
                                    <td><a href="open-tuition-class.php?id_kelas=<?php echo $data['id_kelas']?>""><button class="btn btn-primary px-2" >Open</button></a></td>
                                </tr>
                                <?php } ?>

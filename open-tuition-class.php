                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="browse-student.php?nisn=<?php echo $data['nisn']?>"><button class="btn btn-primary px-2">Browse</button></a>
                                        <a href="history-student.php?nisn=<?php echo $data['nisn']?>"><button class="btn btn-danger px-2">History</button></a>
                                    </td>
                                </tr>
                                <?php } ?>
